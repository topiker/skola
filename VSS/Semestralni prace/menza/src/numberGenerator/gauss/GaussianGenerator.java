 ...
 */
public class GaussianGenerator implements GaussianDistributor, RandomNumberGenerator, ILambdaGenerator {
    ...
    private void generateNumbersToHistogram()
    {
        ...
        {
            addNewRandomToHistogram(generateNumber());
        }
    }
    ...
    public double generateNumber() {
        ...
        if(!generate)
        {
            newRandom = z1 * this.parameters.getOdchylka() + this.parameters.getMean();
        }
        else
        {
            ...
            newRandom = z0*this.parameters.getOdchylka() + this.parameters.getMean();
        }
        while(newRandom<=0)
        {
            generationCount +=1;
            ...
            {
                System.err.println("Nedari se vygenerovat kladna cisla se zadanym nastavenim. Program bude ukoncen.");
                System.exit(-1);
            }
